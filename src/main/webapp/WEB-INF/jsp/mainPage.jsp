...
<head>
    ...
    <!--外部式css样式表  -->
     <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/css/polish.css">   
<body>
...
<div id="navBar">
    <!-- 此处加载顶部导航栏 -->
    <!-- 导航栏 -->
    <nav id="daohang" class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="row" id="leftdaohang">
        ...
        <div id="panel" class="col-md-10 col-sm-9">
            ...
            <div class="panel panel-default" >
                ...
                <div class="panel-body" id="zhuyao">
                    <div id="hang" class="row" style="margin-top: 100px; margin-bottom: 100px">
